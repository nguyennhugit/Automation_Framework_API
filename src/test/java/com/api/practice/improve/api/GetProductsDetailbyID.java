...
//                "    \"password\": \"test123\"\n" +"}";
        UserDto requestGetProductsbyID = UserDto.builder()
...
//                        .log().all()
//                        .statusCode(200);
        ValidatableResponse response = LogInApi.getInstance().logIn(requestGetProductsbyID,200);
        token = response
                .extract()
                .jsonPath()
                .getString("token");
